...
#endif
#else   //使用非MSVC编译器的导出导入宏
#define QTLIBRARYCLASS  QDESIGNER_WIDGET_EXPORT
#endif
...
class  QTLIBRARYCLASS CustomDashboard : public QWidget
{
    Q_OBJECT
    ...
    public:
        ...
        explicit CustomDashboard(QWidget *parent = 0);
        ~CustomDashboard();
